  ...
  const maintenanceEvents = [
    {
      id: 1,
      area: "Sector 5",
      task: "Water Pipeline Inspection",
      date: "Apr 4, 2025",
    },
  ...
  return (
    <View style={styles.dashboardBox}>
      ...
      <View style={styles.statusRow}>
        ...
        <Text style={styles.statusText}>
          Ongoing Projects:{" "}
          <Text style={styles.statusValue}>{ongoingCount}</Text>
        </Text>
        <Text style={styles.statusText}>
...
const RealtimeDashboardWidget = () => {
  ...
  const allDashboardItems = [
    {
      id: 1,
      label: "🚨 Water Leak Detected at Zone : ",
      value: " 4",
      visible: true,
    },
    {
    ...
    {
      id: 8,
      label: "🚦 Traffic Light Malfunction at ",
      value: " Junction 5",
      visible: false,
    },
...
export const HomeScreen: React.FC = () => {
  ...
  const [activeWidgets, setActiveWidgets] = useState([
    ...
    "PollutionHotspotsWidget",
    "UpcomingMaintenanceWidget",
    "RecentCitizenReportsWidget",
  ]);
